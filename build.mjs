...
<section class="sec cap">
  <div class="wrap">
    ...
    <figure class="marco rv">
      <img src="assets/escenas/eligiendo.webp" alt="Un padre y su hijo sonriendo junto a dos fat e-bikes frente a una casa de campo al atardecer" loading="lazy" width="1200" height="900">
